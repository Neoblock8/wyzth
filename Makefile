...
truffle-test:
	docker build . -f ./docker/Dockerfile --target wyzth-genesis -t wyzth-genesis
	docker build . -f ./docker/Dockerfile --target wyzth -t wyzth
	docker build . -f ./docker/Dockerfile.truffle -t truffle-test
	docker-compose -f ./tests/truffle/docker-compose.yml up genesis
	docker-compose -f ./tests/truffle/docker-compose.yml up -d wyzth-rpc wyzth-validator1
	sleep 30
